...
public abstract class AbstractFileJDInput implements JDInput {
	 ...
	 *             path doesn't denote an existing file
	 */
	...
	/**
	 * Returns true if given file path ends with ".class" and it contains "$" in
	 * the name.
	 * 
	 * @param filePath
	 * @return
	...
	/**
	 * Removes ".class".length() number of character from the end of the input
	 * stream.
	 * 
	 * @param classFilePath
	 * @return
