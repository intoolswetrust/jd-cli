...
/**
 * This interface is used for the decompiler output plugins. It contains methods
 * for processing classes and resources.
 * <p>
 * Usual workflow is:
 * <ol>
 * <li>{@link #init(String)} mehod is called to initialize plugin</li>
 * <li>cycle through input resources and call
 * {@link #processClass(String, String)} and
...
public interface JDOutput {
	...
	/**
	 * Initialize the plugin for the given input basePath. Resources can be
	 * reserved here.
	 * 
	 * @param basePath
	 *            path to decompiled resource(s) (e.g. directory, jar file, ...)
	 */
	 ...
	 * 
	 * @param classPath
	 *            a class path within a basePath without ".class" extension
	 ...
	 * 
	 * @param filePath
	 *            a path to a resource within a basePath (e.g.
	 *            "org/myproject/translations/messages_en.properties")
	 * @param is
