...
/**
 * Simple class file parser, which reads only a header part of a class and
 * extracts class version info and class name.
 * 
 * @author Josef Cacek
 */
public final class SimpleClassParser {
	...
	/**
	 * Constructor which parses basic class information from the given stream.
	 * It stops reading right after className index is found.
	 * 
	 * @param is
	 *            Input stream
	 */
