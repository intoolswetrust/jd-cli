...
public class CLIArguments implements DecompilerOptions {
	...
	@Parameter(names = { "--escapeUnicodeChars", "-eu" }, description = "escapes unicode characters in decompiled classes")
	private boolean escapeUnicode;

	@Parameter(names = { "--useThis", "-ut" }, description = "prefix member access with this keyword")
	private boolean useThis;

	@Parameter(names = { "--realignLineNumbers", "-ra" }, description = "realign line numbers")
	private boolean realignLineNrs;
